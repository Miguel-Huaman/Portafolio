const SvgGitHub = ({ className }) => {
        ...
        return (
                <svg className={className} viewBox="0 0 1280 720" style={{ fill: 'none', stroke: 'none' }}>
                        ...
                        <path id="tablet" fill="#121212" stroke="#ffff00" stroke-width="19" stroke-miterlimit="10" d="M480.5,449.75
                        ...
                        <path id="celular" fill="#121212" stroke="#ffff00" stroke-width="19" stroke-miterlimit="10" d="M833.5,476.131
